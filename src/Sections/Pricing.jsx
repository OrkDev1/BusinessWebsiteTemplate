...
export default function PricingTable() {
  ...
  return (
    <div className="px-4 py-20">
      <div className="max-w-6xl mx-auto h-fit flex lg:flex-row flex-col gap-4 rounded-xl">
        {plans.map((plan, idx) => (
          <div key={idx} className={`border-2 w-full rounded-box border-base-300 flex flex-col justify-between ${plan.highlight ? "ring-2 ring-primary/80 border-none bg-base-100" : ""}`}>
            <div className="p-6">
