  ...
  return (
    <div className="grid grid-cols-3 gap-6">
      <div className="w-min h-min">
        <div
          className="group relative border border-transparent rounded-field z-0
      [background:linear-gradient(var(--color-base-100),var(--color-base-100))_padding-box,
                   linear-gradient(135deg,var(--color-base-300),var(--color-base-200),var(--color-base-300))_border-box]
      before:content-[''] before:absolute before:inset-0 before:rounded-field 
      before:bg-[url('./noise.png')] before:bg-[length:328px_328px] before:opacity-50"
        >
          <div
            className="relative rounded-field p-8 shadow-xl flex flex-col items-center z-10 
             transform-gpu perspective-[1000px]"
          >
            <svg
              className="fill-primary w-56 h-56 transition-all duration-500 ease-in-out 
               drop-shadow-[0_0_16px_var(--color-primary)] 
               group-hover:-translate-y-2 
               group-hover:drop-shadow-[0_0_30px_var(--color-primary)]"
              version="1.0"
...
-16z"
            ...
            <div className="px-6 py-5 text-center">
              ...
              <p className="text-md">Using our AI speed up the process. Save time and money</p>
            </div>
          </div>
        </div>
      </div>
